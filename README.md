...
ICESEE includes a fully automated continuous integration workflow that validates installation, dependency resolution, and core data assimilation functionality on every pull request and code update.

Each CI run automatically:

- Installs ICESEE from source
- Verifies package imports and dependencies
- Executes the Lorenz-96 data assimilation benchmark
- Generates scientific outputs
- Produces verification figures
- Validates end-to-end workflow execution

The CI workflow serves as a scientific regression test, ensuring that future code changes preserve reproducibility and core functionality.

## Latest Lorenz-96 Assimilation Benchmark

<p align="center">
<img src="scripts/ci/figures/lorenz96_ci.png" width="900">
</p>
...
The figure shown above is generated directly from the automated test workflow and serves as a lightweight end-to-end verification of the framework.
